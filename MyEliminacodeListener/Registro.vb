...
Public Class Registro
    Public Function Leggi(ByVal NomeChiave As String, ByVal NomeValore As String) As String
        ...
        Chiave = Registry.CurrentUser.OpenSubKey("SOFTWARE\MECLISTENER\" + NomeChiave)
    ...
    Public Sub Scrivi(ByVal NomeChiave As String, ByVal NomeValore As String, ByVal Valore As String)
        ...
        Chiave = Registry.CurrentUser.OpenSubKey("SOFTWARE\MECLISTENER\" + NomeChiave, True)
        If Chiave Is Nothing Then
            Chiave = Registry.CurrentUser.CreateSubKey("SOFTWARE\MECLISTENER\" + NomeChiave)
        End If
