...
$sql = "select * from coda_ambulatori where sportello = '".$postazione."' and turno = '".$turno."' and dachiamare = '0' order by ID ASC limit 1";
...
if ($rownumeri = mysqli_fetch_assoc($rsnumeri)) {
	...
	$sql = "update coda_ambulatori set dachiamare = '1', orariochiamata = current_timestamp where ID = ".$id;
